...
// this is modified from ptera_cs so it does what we need in the game
public class ptera_cs2 : MonoBehaviour
{
    public float FlyX,FlyY,FlyZ;
    ...
    float turn,pitch,open,balance,roll,pitch2,velocity,animcount,Scale = 0.0F;
    ...
    void Update ()
    {
        ...
        // use the code below for reference how to set the animation
        ...
        */
        ...
        //***************************************************************************************
        // this code control the neck rotation with the mouse, we dont need this
        /*
        ...
        */
        ...
        // this resets the nect back to neutral
        if(turn != 0.0F || pitch !=0.0F) // Reset neck
        {
            if(turn <0.0F)
            {
        ...
        // this code control the body's roll pitch yaw with the keyboard
        /*
        ...
        */
        ...
        // this resets the rol pitch yaw to be neutral
    ...
    void FixedUpdate ()
    {
            ...
            anim.GetCurrentAnimatorStateInfo (0).IsName ("Ptera|GlideGrowl"))
        {
            ...
            */
            ...
            // this piece of code decelerate any movement
            // Y = up and down
