...
public class NetworkBootstrapCustom : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        if (ServerDiscovery.Instance.isServer)
        {
            ...
            ServerDiscovery.Instance.enableBroadcast = true; // What normally is done in Server GO Start routine in serverscene
        ...
        NetworkServerDiscovery.Instance.enableBroadcast = true;
